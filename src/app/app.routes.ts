...
import {CreateActivityPageComponent} from './home/pages/create-activity/create-activity';
...
export const routes: Routes = [
  ...
  {path: 'register', canActivate: [openRegisterDialogGuard], component: HomeComponent},
  {
    ...
    children: [
      ...
      {path: 'create-activity', component: CreateActivityPageComponent, canActivate: [authDialogGuard]},
    ]
  },
  {path: '**', redirectTo: ''}
];
