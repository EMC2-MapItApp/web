...
export class RegisterDialogComponent {
  ...
  get nameCtrl() {
    return this.step2Form.controls['name'];
  }
  get emailCtrl() {
    return this.step2Form.controls['email'];
  }
  get passwordCtrl() {
    return this.step2Form.controls['password'];
  }
  get passwordConfirmCtrl() {
    return this.step2Form.controls['passwordConfirm'];
  }
  get businessNameCtrl() {
    return this.step3ProfessionalForm.controls['businessName'];
  }
  get cifCtrl() {
    return this.step3ProfessionalForm.controls['cif'];
  }
  get proPhoneCtrl() {
    return this.step3ProfessionalForm.controls['phone'];
  }
  get proAddressCtrl() {
    return this.step3ProfessionalForm.controls['address'];
  }
  get entityNameCtrl() {
    return this.step3EntityForm.controls['entityName'];
  }
  get entityTypeCtrl() {
    return this.step3EntityForm.controls['entityType'];
  }
  get entPhoneCtrl() {
    return this.step3EntityForm.controls['phone'];
  }
  get entAddressCtrl() {
    return this.step3EntityForm.controls['address'];
  }
  ...
  get step3Valid(): boolean {
    switch (this.selectedType()) {
      case 'individual':
        return true;
      case 'professional':
        return this.step3ProfessionalForm.valid;
      case 'entity':
        return this.step3EntityForm.valid;
      default:
        return false;
    }
  }
      ...
      error: (err) => {
        ...
        this.errorMsg.set(
          err.status === 409
            ...
            : err.error?.error?.code === 'WEAK_PASSWORD'
